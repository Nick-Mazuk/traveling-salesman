export class Block {
    ...
    draw(ctx: CanvasRenderingContext2D, blockXSize: number, blockYSize: number): void {
        ...
        ctx.quadraticCurveTo((this.xPos + this.width) * blockXSize, this.yPos * blockYSize, (this.xPos + this.width) * blockXSize, this.yPos * blockYSize + radius);
        ctx.lineTo((this.xPos + this.width) * blockXSize, (this.yPos + this.height) * blockYSize - radius);
        ctx.quadraticCurveTo((this.xPos + this.width) * blockXSize, (this.yPos + this.height) * blockYSize, (this.xPos + this.width) * blockXSize - radius, (this.yPos + this.height) * blockYSize);
